...
class Trainer(object):
    def __init__(self, args):
        ...
        self.val_evaler = Evaler(
            ...
            geo_feats_folder=cfg.DATA_LOADER.GEO_FEATS_FOLDER
        )
    ...
    def make_kwargs(self, indices, input_seq, target_seq, gv_feat, att_feats, att_mask, geo_feats):
        ...
        # Cast target_seq to torch.LongTensor
    ...
    def forward(self, kwargs):
        if self.rl_stage == False:
            ...
            geo_feats = kwargs[cfg.PARAM.GEO_FEATS]
            ...
            kwargs[cfg.PARAM.GEO_FEATS] = geo_feats
            ...
            geo_feats = utils.expand_tensor(geo_feats, cfg.DATA_LOADER.SEQ_PER_IMG)
    ...
    def train(self):
        ...
        for epoch in range(cfg.SOLVER.MAX_EPOCH):
            ...
            for _, (indices, input_seq, target_seq, gv_feat, att_feats, att_mask, geo_feats) in enumerate(
                ...
                geo_feats = geo_feats.cuda()

                kwargs = self.make_kwargs(indices, input_seq, target_seq, gv_feat, att_feats, att_mask, geo_feats)
