...
# Update paths as per your requirement
__C.DATA_LOADER.TRAIN_GV_FEAT = 'gdata/Alamgir/mscoco/feature/up_down_100'
__C.DATA_LOADER.TRAIN_ATT_FEATS = 'gdata/Alamgir/mscoco/feature/up_down_100'
__C.DATA_LOADER.VAL_GV_FEAT = 'gdata/Alamgir/mscoco/feature/up_down_100'
__C.DATA_LOADER.VAL_ATT_FEATS = 'gdata/Alamgir/mscoco/feature/up_down_100'
__C.DATA_LOADER.TEST_GV_FEAT = 'gdata/Alamgir/mscoco/feature/up_down_100'
__C.DATA_LOADER.TEST_ATT_FEATS = 'gdata/Alamgir/mscoco/feature/up_down_100'

__C.DATA_LOADER.TRAIN_ID = 'gdata/Alamgir/mscoco/txt/coco_train_image_id.txt'
__C.DATA_LOADER.VAL_ID = 'gdata/Alamgir/mscoco/txt/coco_val_image_id.txt'
__C.DATA_LOADER.TEST_ID = 'gdata/Alamgir/mscoco/txt/coco_test_image_id.txt'

__C.DATA_LOADER.INPUT_SEQ_PATH = 'gdata/Alamgir/mscoco/sent/coco_train_input.pkl'
__C.DATA_LOADER.TARGET_SEQ_PATH = 'gdata/Alamgir/mscoco/sent/coco_train_target.pkl'
...
__C.DATA_LOADER.GEO_FEATS_FOLDER = 'gdata/Alamgir/mscoco/feature/tranfifty/geo_feats'  # Updated path
...
__C.MODEL.GEO_DIM = 30  # Adding geometric feature dimension
__C.MODEL.DROPOUT_GEO_FEAT = 0.1  # Add the new dropout key for geometric features
...
__C.SCORER.GT_PATH = 'gdata/Alamgir/mscoco/misc/coco_train_gts.pkl'
__C.SCORER.CIDER_CACHED = 'gdata/Alamgir/mscoco/misc/coco_train_cider.pkl'
...
__C.PARAM.GEO_FEATS = 'GEO_FEATS'  # Add parameter for geometric features

# ---------------------------------------------------------------------------- #
# Inference options
# ---------------------------------------------------------------------------- #
__C.INFERENCE = edict()
__C.INFERENCE.VOCAB = 'gdata/Alamgir/mscoco/txt/coco_vocabulary.txt'
__C.INFERENCE.ID_KEY = 'image_id'
__C.INFERENCE.CAP_KEY = 'caption'
__C.INFERENCE.EVAL = 'COCO'
__C.INFERENCE.VAL_ANNFILE = 'gdata/Alamgir/mscoco/misc/captions_val5k.json'
__C.INFERENCE.TEST_ANNFILE = 'gdata/Alamgir/mscoco/misc/captions_test5k.json'
__C.INFERENCE.BEAM_SIZE = 1
__C.INFERENCE.GREEDY_DECODE = True # Greedy decode or sample decode
__C.INFERENCE.COCO_PATH = '/ghome/Alamgir/LSTMTran/coco_caption'
...
__C.SEED = -1.0
__C.TEMP_DIR = '/ghome/Alamgir/LSTMTran/data/temp'
...
def cfg_from_file(filename):
    ...
    with open(filename, 'r') as f:
        # Use FullLoader to safely load the YAML file
